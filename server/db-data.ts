...
export const BURGERS: any = {
  2: {
    ...
    description: '',
    iconUrl:
      'https://previews.123rf.com/images/mjutapix/mjutapix0612/mjutapix061200034/682773-simple-burger.jpg',
    price: 5,
  ...
  3: {
    ...
    description: '',
    iconUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Cheeseburger.jpg/300px-Cheeseburger.jpg',
    price: 7,
